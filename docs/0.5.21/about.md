...
## Our logo
In the very first versions of Kwirth, we stylized an old photograph of Niklaus Wirth. Then, we converted it into ASCII art, which is shown on every Kwirth server at start-up, just after displaying the version number and before it starts writing the initialization process message logs.

The logo shown in this documentation is also a B&W-processed photograph of Niklaus Wirth.

In Kwirth 0.5.21, we launched **Magnify**, which has, in fact, a double meaning:
...
![kwirthlogo](https://jfvilas.github.io/kwirth/_media/kwirth-last.png ':class=imageclass60')
...
Last months we've been working on different deployments for Kwirth (Docker, desktop, standalone...). It has been very interesting and we're very very proud of what we have achieved thanks to be using a well-architected and full-stacked approach.
