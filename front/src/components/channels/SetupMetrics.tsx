                ...
                <Stack spacing={2} direction={'column'} sx={{ mt:'16px' }}>
                    <Stack direction={'row'} spacing={1} >
                        <FormControl sx={{width:'25%'}}>
                            ...
                            <Select value={metricsMode} onChange={(e) => setMetricsMode(e.target.value)} variant='standard' disabled>
                    ...
                    <Stack direction={'row'} spacing={1} sx={{width:'100%', height:'22vh'}}>
                        ...
                        <Stack direction={'column'} sx={{width:'30%'}} spacing={1}>
                            ...
                            <FormControlLabel control={<Checkbox checked={assetStack} onChange={(e) => setAssetStack(e.target.checked)}/>} disabled={!assetMerge || !('area bar'.includes(chartType))} label='Stack' />
                            <FormControl variant="standard">
                                <InputLabel sx={{ml:1}}>Chart</InputLabel>
                                <Select value={chartType.toString()} onChange={(e) => setChartType(e.target.value)} sx={{ml:1}} variant='standard'>
